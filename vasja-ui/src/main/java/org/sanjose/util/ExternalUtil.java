...
public class ExternalUtil {
    private static final Logger log = LoggerFactory.getLogger(ExternalUtil.class);
    ...
    public static Map<Character, TipoCambio> actualizaTipoCambioNubes() {
