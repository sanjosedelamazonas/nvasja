 ...
 */
@Embeddable
public class ScpRendicioncabeceraPK implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ScpRendicioncabeceraPK)) {
            return false;
        }
        ScpRendicioncabeceraPK castOther = (ScpRendicioncabeceraPK) other;
        return
