 ...
 */
@Entity
@Table(name="scp_destinorendicion")
@NamedQuery(name="ScpDestinorendicion.findAll", query="SELECT s FROM ScpDestinorendicion s")
public class ScpDestinorendicion implements Serializable {
