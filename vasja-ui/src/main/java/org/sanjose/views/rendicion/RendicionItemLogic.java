...
//        view.getSelResponsable().addValidator(new LocalizedBeanValidator(ScpRendiciondetalle.class, "codDestino"));
//        view.getSelLugarGasto().addValidator(new LocalizedBeanValidator(ScpRendiciondetalle.class, "codContraparte"));
//        view.getSelCodAuxiliar().addValidator(new LocalizedBeanValidator(ScpRendiciondetalle.class, "codDestinoitem"));
//        view.getGlosaCabeza().setDescription("Glosa Cabeza");
//        view.getGlosaCabeza().addValidator(new LocalizedBeanValidator(ScpRendicioncabecera.class, "txtGlosa"));
//        view.getGlosaDetalle().setDescription("Glosa Detalle");
//        view.getGlosaDetalle().addValidator(new LocalizedBeanValidator(ScpRendiciondetalle.class, "txtGlosaitem"));
//        view.getSerieDoc().addValidator(new LocalizedBeanValidator(ScpRendiciondetalle.class, "txtSeriecomprobantepago"));
//        view.getNumDoc().addValidator(new LocalizedBeanValidator(ScpRendiciondetalle.class, "txtComprobantepago"));
//        view.getSelCtaContable().addValidator(new LocalizedBeanValidator(ScpRendiciondetalle.class, "codContracta"));
//        view.getSelTipoMov().addValidator(new LocalizedBeanValidator(ScpRendiciondetalle.class, "codTipomov"));
//        view.getSelCodAuxCabeza().addValidator(new LocalizedBeanValidator(ScpRendicioncabecera.class, "codDestino"));
//        view.getSelCuenta().addValidator(new LocalizedBeanValidator(ScpRendicioncabecera.class, "codCtacontable"));
...
//                DataUtil.getRendicionCuentas(newFecha, view.getService().getPlanRepo()),
...
//            BigDecimal saldo = procUtil.getSaldoRendicion(GenUtil.getEndOfDay(GenUtil.dateAddDays(view.getDataFechaComprobante().getValue(),-1)),
    ...
    private void setEditorProyectoLogic(String codProyecto) {
        if (!GenUtil.strNullOrEmpty(codProyecto)) {
            ...
            DataFilterUtil.refreshComboBox(view.getSelTipoMov(),
                    view.getService().getConfiguractacajaRendicionRepo().findByActivoAndParaRendicionAndParaProyecto(true, true, true),
                    "codTipocuenta", "txtTipocuenta", "id");
            // Reset those fields
            if (!isEdit) {
...
*/
   ...
   /*     if (!GenUtil.strNullOrEmpty(item.getCodProyecto()) && !GenUtil.strNullOrEmpty(item.getCodTercero())) {
    ...
    protected void setNumVoucher(ScpRendiciondetalle item) {
        //if (item.getScpRendicioncabecera() != null && !GenUtil.strNullOrEmpty(item.getScpRendicioncabecera().get)) {
//            view.getNumVoucher().setValue(item.getScpRendicioncabecera().getTxtCorrelativo());
