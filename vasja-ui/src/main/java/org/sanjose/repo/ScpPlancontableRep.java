...
public interface ScpPlancontableRep extends JpaRepository<ScpPlancontable, Long> {
	...
	List<ScpPlancontable> findByIndTipomonedaAndFlgEstadocuentaLikeAndFlgMovimientoAndId_TxtAnoprocesoAndId_CodCtacontableLikeOrIndTipomonedaAndFlgEstadocuentaAndFlgMovimientoAndId_TxtAnoprocesoAndId_CodCtacontableLike (
			Character moneda, Character activa, Character mov, String ano, String codcta,
			Character moneda2, Character activa2, Character mov2, String ano2, String codcta2);
	...
	List<ScpPlancontable> findByFlgEstadocuentaAndFlgMovimientoAndId_TxtAnoprocesoAndId_CodCtacontableNotLike(
			Character activa, Character mov, String ano, String codcta);
